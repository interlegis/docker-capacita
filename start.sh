...
echo "3. Inicializando tabelas do BD"
PGPASSWORD=$CAPACITADB_ENV_POSTGRES_PASSWORD psql -U capacita -h capacitadb capacita < /var/interlegis/capacita/capacita.sql
